...
namespace RamiiYoussef\Kafka\Console;

use Illuminate\Support\Carbon;
use Illuminate\Console\Command;
use Illuminate\Contracts\Cache\Repository as Cache;
use RamiiYoussef\Kafka\Worker;
use RamiiYoussef\Kafka\WorkerOptions;
...
class ConsumeCommand extends Command
{
     ...
     *
     * @param  \RamiiYoussef\Kafka\Worker  $worker
     ...
     *
     * @return \RamiiYoussef\Kafka\WorkerOptions
     */
