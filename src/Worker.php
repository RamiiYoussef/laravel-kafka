...
use RamiiYoussef\Kafka\Events\MessageFailed;
use RamiiYoussef\Kafka\Events\MessageIgnored;
use RamiiYoussef\Kafka\Events\WorkerStopping;
use RamiiYoussef\Kafka\Events\MessageProcessed;
use RamiiYoussef\Kafka\Events\MessageProcessing;
...
class Worker
{
     ...
     *
     * @param  \RamiiYoussef\Kafka\Contracts\Factory  $manager
     ...
     * @param  string  $topic
     * @param  \RamiiYoussef\Kafka\WorkerOptions  $options
     *
     * @return void
     */
     ...
     * @param  string  $topic
     *
     * @return \RamiiYoussef\Kafka\Processor\Message|null
     */
     ...
     *
     * @return \RamiiYoussef\Kafka\Processor\Message  $message
     * @param  \RamiiYoussef\Kafka\Consumer  $consumer
     * @param  string  $connectionName
     *
     * @return void
     ...
     * @param  \RamiiYoussef\Kafka\Processor\Message  $message
     * @param  \RamiiYoussef\Kafka\Consumer  $consumer
     * @param  \RamiiYoussef\Kafka\Exceptions\TopicNotBoundException  $e
     *
     ...
     *
     * @return \RamiiYoussef\Kafka\KafkaManager
     */
